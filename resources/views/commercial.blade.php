...
<div class="container">
    <div class="wrapper center-block">
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="<?php echo asset('system_images/commercial/basic.jpg'); ?>" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapsemodel" class="panel-collapse collapse" role="tabpanel" aria-labelledby="model_graph">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="<?php echo asset('system_images/commercial/grp.jpg'); ?>" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="<?php echo asset('system_images/commercial/lcd.jpg'); ?>" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="<?php echo asset('system_images/commercial/led.jpg'); ?>" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="solar_system">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsesolar" aria-expanded="false" aria-controls="collapseThree">
                        Solar System
                    </a>
                </div>
                <div id="collapsesolar" class="panel-collapse collapse" role="tabpanel" aria-labelledby="solar_system">
                    <div class="panel-body">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <ul>
                                            ...
                                            <li>Advance circuit balancing an optimum high brightness with extended battery life.</li>
                                            <li>Multi Chip High Power LED with 50,000 hours of Life </li>
                                            <li>Powered by 12volts 8AH SMF Lead Acid battery easily available for future replacement</li>
                                            <li>Inbuilt Charge Controller for solar panel charging. </li>
                                            <li>12 watt/20 Watt Mono / Multi crystalline Solar Panel </li>
                                            <li>Optional AC charging recharges at very low voltage ( range from 110v to 240v) </li>
                                            <li>Smart Battery Indicator that allows the user to manage his power effectively</li>
                                        </ul>
                            ...
                            <div class="col-md-4">
                                <img src="<?php echo asset('system_images/commercial/solar.jpg'); ?>" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
